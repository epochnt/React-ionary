...
// assume this to be injected bundle of react code
const pizzas = [
  {
    name: "Focaccia",
    price: 6,
...
const server = createServer((req, res) => {
  ...
  if (pathName === "/") {
    // SSRd react on the server and sent with the html, babel need to procees and react-dom to genteate html string
